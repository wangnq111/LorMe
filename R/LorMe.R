...
#'   \item \code{\link{Trans_from_phylo}} - Convert *phyloseq* objects to LorMe.
#'   \item \code{\link{Trans_to_phylo}} - Export LorMe to *phyloseq*.
#'   \item \code{\link{Trans_from_microeco}} - Convert *microtable* (microeco) to LorMe.
#'   \item \code{\link{Trans_to_microeco}} - Export LorMe to *microtable*.
